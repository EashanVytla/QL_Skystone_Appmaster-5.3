...
object RRQLKinematics {
     ...
     */
    @JvmStatic
    fun relativeOdometryUpdate(fieldPose: Pose2d, robotPoseDelta: Pose2d, heading : Double): Pose2d {
        ...
        val fieldPoseDelta = Pose2d(fieldPositionDelta.rotated(heading), robotPoseDelta.heading)
